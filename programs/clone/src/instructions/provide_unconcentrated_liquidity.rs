...
//         onusd_liquidity_valuemantissa().try_into().unwrap,
//     )?;
...
//         liquidity_token_valuemantissa().try_into().unwrap,
//     )?;
...
//         lp_token_delta: liquidity_token_valuemantissa().try_into().unwrap,
//         onusd_delta: onusd_liquidity_valuemantissa().try_into().unwrap,
...
//             .try_into()
//             .unwrap(),
//         oracle_price: oracle_pricemantissa().try_into().unwrap
//     });
