...
/**
 * InsufficientUSDiCollateral: 'Insufficient USDi Collateral'
 *
 * @category Errors
 * @category generated
 */
export class InsufficientUSDiCollateralError extends Error {
  readonly code: number = 0x1787
  readonly name: string = 'InsufficientUSDiCollateral'
  constructor() {
    super('Insufficient USDi Collateral')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, InsufficientUSDiCollateralError)
    }
  }
}
...
createErrorFromCodeLookup.set(
  0x1787,
  () => new InsufficientUSDiCollateralError()
)
createErrorFromNameLookup.set(
...
/**
 * RequireOnlyUSDiCollateral: 'Collateral must be all in USDi'
 *
 * @category Errors
 * @category generated
 */
export class RequireOnlyUSDiCollateralError extends Error {
  readonly code: number = 0x17a0
  readonly name: string = 'RequireOnlyUSDiCollateral'
  constructor() {
    super('Collateral must be all in USDi')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, RequireOnlyUSDiCollateralError)
    }
  }
}
...
createErrorFromCodeLookup.set(
  0x17a0,
  () => new RequireOnlyUSDiCollateralError()
)
createErrorFromNameLookup.set(
