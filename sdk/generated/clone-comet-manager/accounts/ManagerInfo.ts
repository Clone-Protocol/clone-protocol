...
export class ManagerInfo implements ManagerInfoArgs {
  private constructor(
    readonly cloneProgram: web3.PublicKey,
    ...
    readonly netValueOnusd: beet.bignum,
  ...
  static gpaBuilder(
    programId: web3.PublicKey = new web3.PublicKey(
      'HX81GDFSZ9GktdpQCg8N1sBRr1AydZMnkpkNw7dffQym'
    )
  ) {
  ...
  pretty() {
    return {
      cloneProgram: this.cloneProgram.toBase58(),
      ...
      netValueOnusd: (() => {
        const x = <{ toNumber: () => number }>this.netValueOnusd
        if (typeof x.toNumber === 'function') {
          try {
            return x.toNumber()
          } catch (_) {
...
>(
  [
    ...
    ['cloneProgram', beetSolana.publicKey],
